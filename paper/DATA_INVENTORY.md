...
- Checkpoints (current run):
  - `training/checkpoints/gspo_<SUFFIX>/final_model/` (rolling latest; e.g., `gspo_NEWCOMPOSITERUN`)
  - `training/checkpoints/gspo_<SUFFIX>/final_model_YYYYMMDD/` (dated snapshots)
...
- Files: `timestamped_storage_<SUFFIX>/YYYYMMDD_headlines.json` (fallback: `timestamped_storage/`)
...
- Convenience wrappers:
  - `scripts/run_next_update.py`, `scripts/run_backfill_newrun.py`, `scripts/run_override_update.py`
