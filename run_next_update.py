...
def main() -> int:
    ...
    parser.add_argument("--run_suffix", type=str, default="NEWRUN", help="Storage namespace suffix")
    parser.add_argument("--seed", type=int, default=1234, help="Random seed")
    parser.add_argument("--resume_from_last_model", action="store_true", help="Resume from latest NEWRUN final_model")
    ...
    cmd = [
        sys.executable,
        str(repo_root / "run_backfill_newrun.py"),
